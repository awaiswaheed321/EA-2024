...
@Entity
@NamedQuery(name = "Student.canGraduate", query = "SELECT s from Student s JOIN s.coursesAttended c GROUP BY s HAVING s.gpa >= 3.0 AND COUNT(c) >= 9", lockMode = LockModeType.PESSIMISTIC_READ)
